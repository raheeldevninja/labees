...
class AuthService {
  ...
  static Future<LoginResponse> login(String email, String password) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return LoginResponse(success: false, message: result['errors'][0]['message']);
      }
    ...
    on SocketException {
      return LoginResponse(success: false, message: 'Not connect to internet !');
    }
  ...
  static Future<RegistrationResponse> register(RegistrationData registrationData) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return RegistrationResponse(success: false, message: result['errors'][0]['message']);
      }
        ...
        return RegistrationResponse(success: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return RegistrationResponse(success: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
      return RegistrationResponse(success: false, message: 'Request timeout');
    }
    on FormatException catch (e) {
      return RegistrationResponse(success: false, message: 'Bad response format');
    }
    finally {
      EasyLoading.dismiss();
    }
  ...
  static Future<ForgotPasswordResponse> forgotPassword(String email) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return ForgotPasswordResponse(status: false, message: result['errors'][0]['message']);
      }
        ...
        return ForgotPasswordResponse(status: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return ForgotPasswordResponse(status: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
      return ForgotPasswordResponse(status: false, message: 'Request timeout');
    }
    on FormatException catch (e) {
      return ForgotPasswordResponse(status: false, message: 'Bad response format');
    }
    finally {
      EasyLoading.dismiss();
    }
  ...
  static Future<VerifyOTPResponse> verifyOTP(String email, String otp) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return VerifyOTPResponse(status: false, message: result['errors'][0]['message']);
      }
      else if (response.statusCode == 404) {
        ...
        return VerifyOTPResponse(status: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return VerifyOTPResponse(status: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
  ...
  static Future<NewPasswordResponse> setNewPassword(String email, String otp, String password) async {

    NewPasswordResponse newPasswordResponse;
    String url = '${APIs.baseURL}${APIs.resetPassword}?identity=$email&otp=$otp&password=$password';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return NewPasswordResponse(status: false, message: result['errors'][0]['message']);
      }
        ...
        return NewPasswordResponse(status: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return NewPasswordResponse(status: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
