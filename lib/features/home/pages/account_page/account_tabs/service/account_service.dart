...
class AccountService {
  ...
  static Future<UpdateAccountResponse> updateAccount(AccountData accountData) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return UpdateAccountResponse(success: false, message: result['errors'][0]['message']);
      }
        ...
        return UpdateAccountResponse(success: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return UpdateAccountResponse(success: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
      return UpdateAccountResponse(success: false, message: 'Request timeout');
    }
    on FormatException catch (e) {
      return UpdateAccountResponse(success: false, message: 'Bad response format');
    }
    finally {
      EasyLoading.dismiss();
    }
  ...
  static Future<NewsLetterResponse> newsLetter(String email) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return NewsLetterResponse(status: false, message: result['errors'][0]['message']);
      }
      else if (response.statusCode == 500) {
        return NewsLetterResponse(status: false, message: 'Server Error');
      }
      else {
        return NewsLetterResponse(status: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return NewsLetterResponse(status: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
  ...
  static Future<WalletResponse> getWalletList(int limit, int offset) async {
    ...
    String url = '${APIs.baseURL}${APIs.walletList}?limit=$limit&offset=$offset';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return WalletResponse(status: false, message: result['errors'][0]['message']);
      }
      else if (response.statusCode == 500) {
    ...
    on SocketException {
      return WalletResponse(status: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
  ...
  static Future<MyPointsResponse> getMyPoints(int limit, int offset) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return MyPointsResponse(status: false, message: result['errors'][0]['message']);
      }
      else if (response.statusCode == 500) {
        return MyPointsResponse(status: false, message: 'Server Error');
      }
      else {
        return MyPointsResponse(status: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return MyPointsResponse(status: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
  ...
  static Future<AccountSettingsResponse> getAccountSettings() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return AccountSettingsResponse(status: false, message: result['errors'][0]['message']);
      }
      else if (response.statusCode == 500) {
        return AccountSettingsResponse(status: false, message: 'Server Error');
      }
      else {
        return AccountSettingsResponse(status: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return AccountSettingsResponse(status: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
      return AccountSettingsResponse(status: false, message: 'Request timeout');
    }
    on FormatException catch (e) {
      return AccountSettingsResponse(status: false, message: 'Bad response format');
    }
    finally {
      EasyLoading.dismiss();
    }
  ...
  static Future<ConvertToCurrencyResponse> convertToCurrency(int point) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return ConvertToCurrencyResponse(status: false, message: result['errors'][0]['message']);
      }
      else if (response.statusCode == 422) {
        return ConvertToCurrencyResponse(status: false, message: result['message']);
      }
      else if (response.statusCode == 500) {
        return ConvertToCurrencyResponse(status: false, message: 'Server Error');
      }
      else {
        return ConvertToCurrencyResponse(status: false, message: 'Something went wrong !');
      }
    }
    on SocketException {
      return ConvertToCurrencyResponse(status: false, message: 'Not connect to internet !');
    }
    on TimeoutException catch (e) {
      return ConvertToCurrencyResponse(status: false, message: 'Request timeout');
    }
    on FormatException catch (e) {
      return ConvertToCurrencyResponse(status: false, message: 'Bad response format');
    }
    finally {
      EasyLoading.dismiss();
    }
