...
class OrderProvider extends ChangeNotifier {
  ...
  getOrders(BuildContext context, String orderStatus, int pageSize, int currentPage) async {

    //EasyLoading.show(status: 'loading...');
    showLoading();

    ordersResponse = await OrderService.getOrders(orderStatus, pageSize, currentPage);
  ...
  addReview(int productId, String comment, double rating) async {
    ...
    addReviewResponse = await OrderService.addReview(productId, comment, rating);
