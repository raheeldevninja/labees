...
class StaticPageDetailsScreen extends StatefulWidget {
  ...
  @override
  State<StaticPageDetailsScreen> createState() => _StaticPageDetailsScreenState();
}
...
class _StaticPageDetailsScreenState extends State<StaticPageDetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      settingsProvider.getPageDetails(widget.slug);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(settingsProvider.getIsLoading ? '' : settingsProvider.pageDetailsResponse?.name ?? '',
