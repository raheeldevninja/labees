...
class _ContactUsScreenState extends State<ContactUsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: settingsProvider.getIsLoading ? const SizedBox() : Form(
        key: _formKey,
        child: ListView(
              ...
              child: SimpleButton(
                ...
                callback: () async {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    int inquiryTypeNo = typesOfInquiry.indexOf(selectedTypesOfInquiry!);
                    ...
                    ContactStoreData contactStoreData = ContactStoreData(
                      ...
                      mobileNumber: '$selectedCountryCode-${_phoneController.text.trim()}',
                    );

                    await settingsProvider.contactUs(context, contactStoreData);
                  }
            ...
            Container(
              ...
              child:
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text(l10n.contactDetails, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.normal),),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          settingsProvider.companySettingsResponse.companyPhone!,
                          style: const TextStyle(
                            fontSize: 14,
                            color: Colors.grey,
                          ),
                ...
                Row(children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        settingsProvider.companySettingsResponse.companyEmail!,
                      ),
