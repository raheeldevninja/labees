...
class _SummarySheetState extends State<SummarySheet> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      cartProvider.setSelectShippingMethod(context.read<CartProvider>().getShippingMethodsList.first);
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if(cartProvider.applyCouponResponse != null && cartProvider.applyCouponResponse!.data != null) {

          discountType = cartProvider.applyCouponResponse!.data!.coupon!.discountType!;
        ...
        return DraggableScrollableSheet(
          ...
          builder: (BuildContext context, ScrollController scrollController) {
            return cartProvider.selectedShippingMethod == null ? const SizedBox() : DecoratedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: InkWell(
                                    onTap: () {
                                      ...
                                      cartProvider.applyCoupon(_couponCodeController.text.trim(),
                                          subTotal.toInt(),
                                          cartProvider.selectedShippingMethod!.cost!
                                      );
                              ...
                              DropdownButtonFormField<ShippingMethod>(
                                //value: selectedValue,
                                value: cartProvider.getSelectedShippingMethod(),
                                ...
                                items: cartProvider.shippingMethodsList.map((ShippingMethod item) {
                                  return DropdownMenuItem<ShippingMethod>(
                                    value: item,
                                    child: Text('${item.title!} - Sar ${item.cost}'),
                                  );
                                }).toList(),
                                onChanged: (value) {
                                  /*setState(() {
                                  ...
                                  cartProvider.setSelectShippingMethod(value!);
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    cartProvider.selectedShippingMethod!.title!,
                                    style: const TextStyle(
                                        fontFamily: 'Montserrat',
                                        fontSize: 14,
                                        fontWeight: FontWeight.w500),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Sar ${subTotal + cartProvider.selectedShippingMethod!.cost! + (0.15 * subTotal)
                                        + cartProvider.couponDiscount}',
                                    style: const TextStyle(
                                        fontFamily: 'Montserrat',
                                        fontSize: 18,
                                        fontWeight: FontWeight.w600),
